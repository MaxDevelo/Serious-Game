...
- Ajouter un bouton Quitter une fois la partie terminée.
- Avoir des informations sur l'évolution des pourcentages des choix des actions
...
Justifications : Les noms des fichiers sont parffaitement conformes à ce qu'ils doivent présenter dans l'application, les commits sont réguliers et pertinents, et le Readme est très complet et donne beaucoup de détails.
...
Justifications : La procédure d'installation est indiqué dans le Readme et tout se passe sans problème. Une fois lancé, on nous propose de jouer ou de quitter le jeu.
Après avoir choisi la map, le narrateur nous explique le fonctionnement du tour. Il y a des petits bugs d'affichage mais n'ont pas d'impact sur la partie.
L'historicité exposée avec une capture d'écran du tour précédent permet de constater les conséquences de notre choix lors de ce tour, permettant la compréhension des 
impacts de ces actions sur le territoire.
...
Justifications : Le cahier des charges est bien structuré, on peut facilement se rendre à une partie précise du cahier, et l'ensemble des actions réalisables, des activités avec la description de leur conséquence, la description d'un tour nous permettent parfaitement de savoir ce qu'on va avoir en lançant une partie de ce jeu.
...
Justifications : Le déroulement et la gestion d'un tour étant expliquée entièrement , les descriptions des actions du jouer, du moteur interne et des informations du joueur sont pertinentes et permettent la compréhension des interactions avec l'application. En jeu, quand on clique sur une case et qu'on ferme la fenêtre pop-up, l'affichage des noms sur les cases / districts ne se fait plus. Les 3 tailles de map possibles permettent dans l'idée de jouer en prenant en compte des tailles différentes.
...
Justifications : Il y a 2 fins : gagné ou perdu. Les actions changent le pourcentage des jauges donc on peut faire plusieurs choix très différents mais arriver à un des 2 résultats finaux proposés.
